...
case TRANSACTION_getAccelGameList:
{
data.enforceInterface(DESCRIPTOR);
java.util.List<cn.wsds.gamemaster.service.aidl.VpnAccelGame> _result = this.getAccelGameList();
reply.writeNoException();
...
@Override public java.util.List<cn.wsds.gamemaster.service.aidl.VpnAccelGame> getAccelGameList() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List<cn.wsds.gamemaster.service.aidl.VpnAccelGame> _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getAccelGameList, _data, _reply, 0);
_reply.readException();
_result = _reply.createTypedArrayList(cn.wsds.gamemaster.service.aidl.VpnAccelGame.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
static final int TRANSACTION_getAccelGameList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
}
...
public java.util.List<cn.wsds.gamemaster.service.aidl.VpnAccelGame> getAccelGameList() throws android.os.RemoteException;
}
